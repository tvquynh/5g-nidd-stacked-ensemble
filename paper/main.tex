...
\author{
\IEEEauthorblockN{1\textsuperscript{st} Trong-Thua Huynh}
\IEEEauthorblockA{\textit{Information Security Technology Lab}\\
\textit{Posts and Telecommunications Institute of Technology}\\
Vietnam \\
thuaht@ptit.edu.vn \,/\, ORCID 0000-0003-3934-1067}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Van-Quynh Trinh\,(\textit{corresp.})}
\IEEEauthorblockA{\textit{Information Security Technology Lab}\\
\textit{Posts and Telecommunications Institute of Technology}\\
Vietnam \\
