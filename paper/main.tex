...
\end{minipage}%
\begin{minipage}[t]{0.48\textwidth}\centering
\textbf{2\textsuperscript{nd} Van-Quynh Trinh \textit{(corresp.)}}\\[0.25em]
\textit{Information Security Technology Lab}\\
\textit{Posts and Telecommunications Institute of Technology}\\
Vietnam\\
...
\end{minipage}\\[1.2em]
\begin{minipage}[t]{0.48\textwidth}\centering
\textbf{3\textsuperscript{rd} De-Thu Huynh}\\[0.25em]
...
\end{minipage}%
\begin{minipage}[t]{0.48\textwidth}\centering
\textbf{4\textsuperscript{th} Ngoc-Hieu Le}\\[0.25em]
\textit{Information Security Technology Lab}\\
\textit{Posts and Telecommunications Institute of Technology}\\
Vietnam\\
