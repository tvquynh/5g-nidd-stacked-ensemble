...
macro-F1 of 0.998, leaving a vanishingly small margin for further
improvement; the stacked ensemble matches the strongest single base
(XGBoost) at 0.999. Under the cross-station split BS1$\rightarrow$BS2
the four methods diverge. The MLP becomes the strongest single
classifier with macro-F1 0.940$\pm$0.013 and binary-F1 0.957$\pm$0.020,
substantially ahead of both gradient-boosted tree variants
(macro-F1 0.93, binary-F1 0.887). The stacked ensemble lands at
macro-F1 0.933$\pm$0.0002 and binary-F1 0.887---between the trees and
the MLP on the mean but with the tightest inter-seed variance by an
order of magnitude. The logistic-regression meta-learner inherits the
...
shi2024_5g_ddos_cnn_lstm} pursue peak accuracy with transformer and
