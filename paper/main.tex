...
\textbf{1\textsuperscript{st} Trong-Thua Huynh}\\[0.25em]
\textit{Information Security Technology Lab}\\
\textit{Posts and Telecommunications Institute of Technology}\\
Vietnam\\
thuaht@ptit.edu.vn \,/\, ORCID 0000-0003-3934-1067
\end{minipage}%
\begin{minipage}[t]{0.48\textwidth}\centering
\textbf{2\textsuperscript{nd} De-Thu Huynh}\\[0.25em]
\textit{School of Computer Science \& Engineering}\\
\textit{The Saigon International University}\\
Vietnam\\
huynhdethu@siu.edu.vn \,/\, ORCID 0000-0002-1227-0281
\end{minipage}\\[1.2em]
\begin{minipage}[t]{0.48\textwidth}\centering
\textbf{3\textsuperscript{rd} Ngoc-Hieu Le}\\[0.25em]
\textit{Information Security Technology Lab}\\
\textit{Posts and Telecommunications Institute of Technology}\\
Vietnam\\
hieuln@ptithcm.edu.vn \,/\, ORCID 0009-0005-4869-9003
\end{minipage}%
\begin{minipage}[t]{0.48\textwidth}\centering
\textbf{4\textsuperscript{th} Van-Quynh Trinh \textit{(corresp.)}}\\[0.25em]
\textit{Information Security Technology Lab}\\
\textit{Posts and Telecommunications Institute of Technology}\\
Vietnam\\
quynhtv@ptithcm.edu.vn \,/\, ORCID 0009-0006-0514-6123
\end{minipage}%
}
...
split BS1$\rightarrow$BS2 (x-axis zoomed to $[0.6, 1.0]$). The MLP
outperforms the trees on the volumetric classes (Benign, UDPFlood);
the trees and the stacked ensemble dominate the application-layer DoS
classes.}
